...
if SERVER then
	...
	-- Special Accomplice Radar, it only shows dead bodies
	...
	hook.Add("TTTAModifyRolesTable", "ModifyRoleAccomToInno", function(rolesTable)
		local accomplices = rolesTable[ROLE_ACCOMPLICE]

		if not accomplices then return end

		rolesTable[ROLE_INNOCENT] = rolesTable[ROLE_INNOCENT] + accomplices
		rolesTable[ROLE_ACCOMPLICE] = 0
	end)
